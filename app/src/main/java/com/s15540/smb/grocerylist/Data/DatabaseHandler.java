package com.s15540.smb.grocerylist.Data;
...
import com.s15540.smb.grocerylist.Util.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addGrocery(Grocery grocery) {
        ...
        values.put(Constants.KEY_PRICE_NAME, grocery.getPrice());
    ...
    public Grocery getGrocery(int id) {
        ...
        Cursor cursor = db.query(Constants.TABLE_NAME, new String[]{Constants.KEY_ID,
                        Constants.KEY_GROCERY_ITEM, Constants.KEY_QTY_NUMBER, Constants.KEY_PRICE_NAME,Constants.KEY_DATE_NAME},
                Constants.KEY_ID + "=?",
        ...
        grocery.setPrice(cursor.getString(cursor.getColumnIndex(Constants.KEY_PRICE_NAME)));
    ...
    public List<Grocery> getAllGroceries() {
        ...
        Cursor cursor = db.query(Constants.TABLE_NAME, new String[]{
                Constants.KEY_ID, Constants.KEY_GROCERY_ITEM, Constants.KEY_QTY_NUMBER, Constants.KEY_PRICE_NAME,
